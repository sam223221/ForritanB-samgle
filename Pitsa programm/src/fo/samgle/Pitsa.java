...
public void pitsa(){
    ...
    //Peproni
    JButton Peproni = new JButton("04 Peproni");
        Peproni.setBounds(50,330,200,50);
        Peproni.setFont(new Font("Verdana",3,17));
        Peproni.addActionListener(new ActionListener(){
        public void actionPerformed(ActionEvent e){ System.out.println("Peproni"); }});
        f.add(Peproni);
